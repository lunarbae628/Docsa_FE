...
export class BranchAPIApi extends runtime.BaseAPI {
   ...
   * 새 브랜치를 생성합니다.
   */
  async createBranchRaw(
    requestParameters: CreateBranchRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BranchCreateResponse>> {
    ...
    const response = await this.request(
      {
        ...
        body: BranchCreateRequestToJSON(
          requestParameters["branchCreateRequest"],
        ),
      },
      initOverrides,
    )
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      BranchCreateResponseFromJSON(jsonValue),
    )
  }
  ...
  async createBranch(
    ...
    const response = await this.createBranchRaw(
      requestParameters,
      initOverrides,
    )
  ...
  async deleteBranchRaw(
    ...
    urlPath = urlPath.replace(
      `{${"branchId"}}`,
      encodeURIComponent(String(requestParameters["branchId"])),
    )
    urlPath = urlPath.replace(
      `{${"documentId"}}`,
      encodeURIComponent(String(requestParameters["documentId"])),
  ...
  /**
   * 브랜치의 이름을 수정합니다. 메인 브랜치의 이름은 수정할 수 없습니다.
   * 브랜치 이름 변경
   */
  async renameBranchRaw(
    requestParameters: RenameBranchRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BranchRenameResponse>> {
    if (requestParameters["branchId"] == null) {
      throw new runtime.RequiredError(
        "branchId",
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: BranchRenameRequestToJSON(
          requestParameters["branchRenameRequest"],
        ),
      },
      initOverrides,
    )
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      BranchRenameResponseFromJSON(jsonValue),
    )
  }
  ...
  async renameBranch(
    ...
    const response = await this.renameBranchRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
